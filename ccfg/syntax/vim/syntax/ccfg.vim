...
syntax keyword C_Lead SECTION SECTION_ADD SECTION_DEL LET LET_ENUM LET_APPEND LET_PREPEND LET_MERGE FOR_EACH FOR_END INCLUDE SEED RESTRICT DEBUG_PRINT
