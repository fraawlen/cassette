...
static const struct resource resources[] =
{
	...
	STYLE_BOX( "button_idle",     config.button_frame[0]   )
	STYLE_BOX( "button_focused",  config.button_frame[1]   )
	STYLE_BOX( "button_pressed",  config.button_frame[2]   )
	STYLE_BOX( "button_disabled", config.button_frame[3]   )
	STYLE_BOX( "beacon_off",      config.beacon_frame[0]   )
	STYLE_BOX( "beacon_on",       config.beacon_frame[1]   )
	STYLE_BOX( "beacon_crit_off", config.beacon_frame[2]   )
	STYLE_BOX( "beacon_crit_on",  config.beacon_frame[3]   )
	...
	STYLE_TXT( "button_idle",     config.button_text[0] )
	STYLE_TXT( "button_focused",  config.button_text[1] )
	STYLE_TXT( "button_pressed",  config.button_text[2] )
	STYLE_TXT( "button_disabled", config.button_text[3] )
	STYLE_TXT( "beacon_off",      config.beacon_text[0] )
	STYLE_TXT( "beacon_on",       config.beacon_text[1] )
	STYLE_TXT( "beacon_crit_off", config.beacon_text[2] )
	STYLE_TXT( "beacon_crit_on",  config.beacon_text[3] )
