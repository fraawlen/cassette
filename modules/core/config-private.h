...
#ifndef DG_CORE_CONFIG_H_PRIVATE
#define DG_CORE_CONFIG_H_PRIVATE
 ...
 * @error DG_CORE_ERRNO_HASHTABLE : inherited from dg_core_resource_push_group()
 */
bool dg_core_config_init(void);

/**
 * Remove the module's config associated resource group from the resource tracker.
 */
void dg_core_config_reset(void);

/************************************************************************************************************/
/************************************************************************************************************/
/************************************************************************************************************/

#endif /* DG_CORE_CONFIG_H_PRIVATE */
