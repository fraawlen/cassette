...
void
(*cgui_cell_get_callback_destroy(cgui_cell_t *cell))(cgui_cell_t *cell)
{
	assert(cgui_is_init());
	assert(cell);
...
void
(*cgui_cell_get_callback_draw(cgui_cell_t *cell))(cgui_cell_t *cell, cgui_cell_drawing_context_t *context)
{
	assert(cgui_is_init());
	assert(cell);
...
void
(*cgui_cell_get_callback_event(cgui_cell_t *cell))(cgui_cell_t *cell, cgui_cell_event_t *event)
{
	assert(cgui_is_init());
	assert(cell);
...
void *
cgui_cell_get_data(cgui_cell_t *cell)
{
	assert(cgui_is_init());
	assert(cell);
...
bool
cgui_cell_is_enabled(cgui_cell_t *cell)
{
	assert(cgui_is_init());
	assert(cell);
...
bool
cgui_cell_has_failed(cgui_cell_t *cell)
{
	assert(cgui_is_init());
	assert(cell);
...
bool
cgui_cell_send_custom_event(cgui_cell_t *cell, unsigned int id, void *data, size_t data_n)
{
	assert(cgui_is_init());
	assert(cell);
...
void
cgui_cell_set_callback_destroy(cgui_cell_t *cell, void (*fn)(cgui_cell_t *cell))
{
	assert(cgui_is_init());
	assert(cell);
...
void
cgui_cell_set_callback_draw(cgui_cell_t *cell, void (*fn)(cgui_cell_t *cell, cgui_cell_drawing_context_t *context))
{
	assert(cgui_is_init());
	assert(cell);
...
void
cgui_cell_set_callback_event(cgui_cell_t *cell, void (*fn)(cgui_cell_t *cell, cgui_cell_event_t *event))
{
	assert(cgui_is_init());
	assert(cell);
